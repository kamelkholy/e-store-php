            ...
            <div class="panel-body">
                <div class="container">
                    ...
                    <div class="row py-2">
                        ...
                        <form action="{{route('types.index')}}" class="form-inline my-2 my-lg-0">
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <form action="{{route('types.destroy', [$row->id])}}" method="POST">
                                        @csrf
                                        {{ method_field('DELETE') }}
                                        <a href="{{route('types.edit', [$row->id])}}" class="btn-sm btn-secondary" style="padding: .5rem .5rem;"><i class="fa fa-edit"></i></a>
