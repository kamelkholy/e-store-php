                        ...
                        <div class="col-md-6">
                            <table class="table">
                                ...
                                <tbody id="specifications" class="text-center">
                                    @foreach($data->specifications as $key=>$spec)
                                    <script>
                                        specifications["{{$key}}"] = {
                                            html: "",
                                            applied: true
                                    ...
                                    <tr id="spec-{{$key}}">
                                        ...
                                        <td><input type="text" name="specifications[{{$key}}][title]" class="form-control" value="{{$spec->title}}" readonly></td>
                                        <td><input type="text" name="specifications[{{$key}}][type]" class="form-control" value="{{$spec->type}}" readonly></td>
                                        <td><input type="text" name="specifications[{{$key}}][values]" class="form-control" value='{{$spec->values}}' readonly></td>
                                    </tr>
                                    @endforeach
                                </tbody>
