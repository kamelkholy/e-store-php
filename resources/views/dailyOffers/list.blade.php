    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">DailyOffers</h3>
            </div>
            <div class="panel-body">
                <div class="container">
                    ...
                    <div class="row py-2">
                        <div class="col pl-0">
                            <a href="{{route('dailyOffers.create')}}" class="btn btn-primary"> Add New</a>
                        </div>
                        <form action="{{route('dailyOffers.index')}}" class="form-inline my-2 my-lg-0">
                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <form action="{{route('dailyOffers.destroy', [$row->id])}}" method="POST">
                                        @csrf
                                        {{ method_field('DELETE') }}
                                        <a href="{{route('dailyOffers.edit', [$row->id])}}" class="btn-sm btn-secondary" style="padding: .5rem .5rem;"><i class="fa fa-edit"></i></a>
