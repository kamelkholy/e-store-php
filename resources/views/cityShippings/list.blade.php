    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">CityShippings</h3>
            </div>
            <div class="panel-body">
                <div class="container">
                    ...
                    <div class="row py-2">
                        <div class="col pl-0">
                            <a href="{{route('cityShippings.create')}}" class="btn btn-primary"> Add New</a>
                        </div>
                        <form action="{{route('cityShippings.index')}}" class="form-inline my-2 my-lg-0">
                    ...
                    <table class="table table-hover table-sm">
                        <thead class="text-center text-white" style="background-color: #A7B2DF;">
                            <tr>
                                ...
                                <th>@sortablelink('shipping_fees', 'Shipping Fees')</th>
                                <th>Actions</th>
                            </tr>
                        </thead>
                        <tbody class="text-center">
                            ...
                            <tr>
                                ...
                                <td class="align-middle">{{ $row->shipping_fees }}</td>
                                <td class="align-middle">
                                    <form action="{{route('cityShippings.destroy', [$row->id])}}" method="POST">
                                        @csrf
                                        {{ method_field('DELETE') }}
                                        <a href="{{route('cityShippings.edit', [$row->id])}}" class="btn-sm btn-secondary" style="padding: .5rem .5rem;"><i class="fa fa-edit"></i></a>
