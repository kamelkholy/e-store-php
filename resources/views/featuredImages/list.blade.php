        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="container">
                    ...
                    <div class="row py-2">
                        <div class="col pl-0">
                            <a href="{{route('featuredImages.create')}}" class="btn btn-primary"> Add New</a>
                        </div>
                        <form action="{{route('featuredImages.index')}}" class="form-inline my-2 my-lg-0">
                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                <td class="align-middle">
                                    @if(isset($row->image))
                                    <img src="{{route('featuredImages.show', [$row->id])}}" class="img-thumbnail" width="75" />
                                    @else
                                ...
                                <td class="align-middle">
                                    <form action="{{route('featuredImages.destroy', [$row->id])}}" method="POST">
                                        @csrf
                                        {{ method_field('DELETE') }}
                                        <a href="{{route('featuredImages.edit', [$row->id])}}" class="btn-sm btn-secondary" style="padding: .5rem .5rem;"><i class="fa fa-edit"></i></a>
