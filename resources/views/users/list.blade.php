            ...
            <div class="panel-body">
                <div class="container">
                    ...
                    <div class="row py-2">
                        ...
                        <form action="{{route('users.index')}}" class="form-inline my-2 my-lg-0">
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <form action="{{route('users.destroy', [$row->id])}}" method="POST">
                                        @csrf
                                        {{ method_field('DELETE') }}
                                        <a href="{{route('users.edit', [$row->id])}}" class="btn-sm btn-secondary" style="padding: .5rem .5rem;"><i class="fa fa-edit"></i></a>
